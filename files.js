...
//   setActiveFile(name);
//   hideWelcome();
//   showNotification(`Opened ${name}`, "check-circle", "#5FC234");
// }
...
//   hideWelcome();
//   showNotification(`Opened folder`, "check-circle", "#5FC234");
// }
...
//   try {
//     await window.electronAPI.saveFile(handle.path, editor.getValue());
...
// }
const openedFiles = [];
const fileHandles = {}; // { [name]: { path, name } }
